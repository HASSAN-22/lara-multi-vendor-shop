        ...
        <div class="">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{route('admin.property.update',['property'=>$property->id])}}" method="post" enctype="multipart/form-data" id="demo-form2" class="form-horizontal form-label-left">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <input type="text" class="form-control font-14" name="property" value="{{old('property') ?? $property->property}}" placeholder="property">
                                </div>
                            </div>
                            <div class="clearfix"></div>
