        ...
        <div class="">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{route('admin.product.update',['product'=>$product->id])}}" method="post" enctype="multipart/form-data" id="demo-form2" class="form-horizontal form-label-left">
                            @csrf
                            @method('PATCH')
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <select name="user_id" id="user_id" class="form-control font-14">
                                                    ...
                                                    @foreach($users as $item)
                                                        <option value="{{$item->id}}" {{in_array($item->id, [old('user_id'),$product->user_id]) ? 'selected' : ''}}>{{$item->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
