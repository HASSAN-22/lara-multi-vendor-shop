        ...
        <div class="">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{route('admin.category.store')}}" method="post" enctype="multipart/form-data" id="demo-form2" class="form-horizontal form-label-left">
                            @csrf
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <select name="parent_id" id="parent_id" class="form-control font-14">
                                        ...
                                        @foreach($categories as $item)
                                            <option value="{{$item->id}}" {{in_array($item->id, [old('parent_id')]) ? 'selected' : ''}}>{{$item->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <textarea name="meta_description" id="meta_description" cols="4" rows="4" class="form-control font-14">{{old('meta_description')}}</textarea>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group mt-3">
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <textarea name="meta_keyword" id="meta_keyword" cols="4" rows="4" class="form-control font-14">{{old('meta_keyword')}}</textarea>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group mt-3">
