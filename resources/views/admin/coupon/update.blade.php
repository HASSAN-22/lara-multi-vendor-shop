        ...
        <div class="">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{route('admin.coupon.update',['coupon'=>$coupon['id']])}}" method="post" enctype="multipart/form-data" id="demo-form2" class="form-horizontal form-label-left">
                            @csrf
                            @method('patch')
                            <div class="form-group mt-3">
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <select name="product_ids[]" multiple class="form-control font-14" id="product_ids">
                                        <?php
                                            $couponProducts = array_merge( $couponProducts, [old('product_ids')]);
                                        ?>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <input type="text" class="form-control font-14" name="code" value="{{old('code')??$coupon['code']}}" placeholder="Code">
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group mt-3">
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <input type="text" class="form-control font-14" name="discount" value="{{old('discount')??$coupon['discount']}}" placeholder="Discount %">
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group mt-3">
