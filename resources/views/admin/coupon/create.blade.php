        ...
        <div class="">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="{{route('admin.coupon.store')}}" method="post" enctype="multipart/form-data" id="demo-form2" class="form-horizontal form-label-left">
                            @csrf
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <select name="product_ids[]" multiple class="form-control font-14" id="product_ids">
                                        @foreach($products as $item)
                                            <option value="{{$item->id}}" {{in_array($item->id, [old('product_ids')]) ? 'selected' : ''}}>{{$item->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <input type="text" class="form-control font-14" name="limit_user" value="{{old('limit_user')}}" placeholder="Limit user">
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group mt-3">
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <input type="date" class="form-control font-14" name="expire_at" value="{{old('expire_at')}}" placeholder="Expire at">
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group mt-3">
