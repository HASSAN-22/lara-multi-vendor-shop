            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_title flex justify-content-between">
                        <div><a href="{{route('vendor.product.create')}}" class="btn btn-info font-14">Add new</a></div>
                        <div>
                                ...
                                @foreach($products as $key=>$item)
                                    <tr>
                                        ...
                                        <td class="flex align-center justify-center">
                                            <a href="{{route('vendor.product.edit',['product'=>$item->id])}}" class="btn btn-info font-14">Edit</a>
                                            <form action="{{route('vendor.product.destroy',['product'=>$item->id])}}" method="post">
                                                @csrf
                                                @method('DELETE')
