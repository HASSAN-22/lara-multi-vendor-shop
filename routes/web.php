...
Route::group([],function(){
    ...
    Route::get('checkout',[\App\Http\Controllers\SiteController::class,'checkout'])->name('front.checkout');
    Route::post('order',[\App\Http\Controllers\SiteController::class,'order'])->name('front.order');
